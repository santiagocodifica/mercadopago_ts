  ...
  return(
    <footer className="p-4 md:p-8 mt-60 flex place-items-end text-2xl md:text-3xl font-serif w-100">
      <p className="w-100 md:w-1/2">
        ...
        <br /><br />
        <a href="https://www.santiagoperdomo.com" target="_blank" className="underline">My personal website</a>
        <br />
        <a href="https://github.com/santiagocodifica" target="_blank" className="underline">Github.</a>
      </p>
    </footer>
  )
}
